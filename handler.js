...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
	    ...
	    let win = ''
	    let tie = false
	    if (m.sender == roof.p2 && /^(acc(ept)?|terima|gas|aying|oke?|tolak|gamau|nanti|napa|ga(k.)?bisa|y)/i.test(m.text) && m.isGroup && roof.status == 'wait') {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            break
	    case 'donasi': case 'sewa': case 'buypremium': case 'donate': {
                kagura.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/74fd634010128be37972c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\n Bot LichCraft\n⭔Dana: 0838-6161-7806\n⭔Gopay: 0838-6161-7806\n\nTerimaKasih Sebesar Besarnya Untuk Donasinya Dari OwnerBot` }, { quoted: m })
            }
            break
            case 'yt': case 'youtube': {
            	m.reply('*Youtube :*\nhttps://youtube.com/c/DitzzCraft')
            }
            break
...
`
                let btn = [{
                        ...
                        kagura.send5ButImg(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙽𝙰𝙽𝙳𝙰𝚇𝙳`, global.thumb, btn)
                        } else if (setbot.templateGif) {
                        kagura.send5ButGif(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙽𝙰𝙽𝙳𝙰𝚇𝙳`, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        kagura.send5ButVid(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙽𝙰𝙽𝙳𝙰𝚇𝙳`, global.visoka, btn)
                        } else if (setbot.templateMsg) {
                        kagura.send5ButMsg(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 𝙽𝙰𝙽𝙳𝙰𝚇𝙳`, btn)
                        }
                     }
            break
            default:
